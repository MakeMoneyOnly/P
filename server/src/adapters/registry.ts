...
import {
  execute as vscodeIdeExecute,
  testEnvironment as vscodeIdeTestEnvironment,
  sessionCodec as vscodeIdeSessionCodec,
  agentConfigurationDoc as vscodeIdeAgentConfigurationDoc,
} from "@paperclipai/adapter-vscode-ide/server";
import {
...
const vscodeIdeAdapter: ServerAdapterModule = {
  type: "vscode_ide",
  execute: vscodeIdeExecute,
  testEnvironment: vscodeIdeTestEnvironment,
  sessionCodec: vscodeIdeSessionCodec,
  agentConfigurationDoc: vscodeIdeAgentConfigurationDoc,
  supportsLocalAgentJwt: false,
  supportsInstructionsBundle: false,
};
